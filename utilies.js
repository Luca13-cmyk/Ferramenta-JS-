...
return {
    ...
    center: function(settings){
        if (window.jQuery){
            ...
            let top = Math.max($window.height() - settings.content.outerHeight(), 0) / 2;
            let left = Math.max($window.width() - settings.content.outerWidth(), 0) / 2;
           
            settings.content.css('position') !== 'fixed' ?  settings.content.css({
            ...
            settings.content.style.left = '50%';
            settings.content.style.top = '50%';
            settings.content.style.transform = 'translate(-50%, -50%)';
            settings.content.style.width = settings.width || 'auto';
            settings.content.style.height = settings.height || 'auto';
